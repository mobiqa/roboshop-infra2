...
module "subnets" {
  ...
  internet_gw_id = lookup(lookup(module.vpc, each.value.vpc_name, null ), "lookup(lookup(module.vpc, each.value.vpc_name, null ), "vpc_peering_connection_id", null)", null)
